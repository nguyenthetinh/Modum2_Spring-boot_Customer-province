package com.tinh.customer.controller;
...
public class CustomerController {
    ...
    @GetMapping("/")
    public ModelAndView listCustomer(@RequestParam("s")Optional<String>s, @PageableDefault(size = 10) Pageable pageable){
    ...
    public ModelAndView saveCustomer(@ModelAttribute("customer")Customer customer){
        ...
        ModelAndView modelAndView = new ModelAndView("/customer/create");
        modelAndView.addObject("customer", new Customer());
        modelAndView.addObject("message","New customer cerated successfully");
        return modelAndView;
    }
